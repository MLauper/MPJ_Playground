...
public class PancakeFlipperSequential implements Serializable {
    ...
    public PancakeFlipperSequential(int[] pancakeOrder, int limit) {
        int[] augmentedPancakeOrder = new int[pancakeOrder.length + 1];
    ...
    public PancakeFlipperSequential(){
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        if (rank == 0) {
            ...
            PancakeFlipperSequential pancakeFlipper = new PancakeFlipperSequential(initialPancakeOrder);
            ...
            while(solutionRequest.Test() == null){
                ...
                if(waitingWorker.size() == numOfRanks-1){
                    ...
                    pancakeFlipper = new PancakeFlipperSequential(initialPancakeOrder, globalCandidateLimit);
            ...
            PancakeFlipperSequential pancakeFlipper = new PancakeFlipperSequential();
            ...
            if ((stateStack.peek().heuristicNumber + stateStack.peek().depth) > limit) {
                ...
                if (stateStack.peek().depth == 0) {
                    ...
                    while(initialSeedReceiveRequest.Test() == null){
                        ...
                        if (i >= 2){
                            System.out.println("(possible) Rerequesting work...");
                            //MPI.COMM_WORLD.Isend(sendArr,0,1,MPI.INT,0,TAGS.NEW_LIMIT);
                        }
